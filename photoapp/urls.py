...
from .views import PhotoListView, PhotoTagListView, PhotoDetailView, PhotoCreateView, PhotoUpdateView, PhotoDeleteView, like_photo, follow_user
from .import views
app_name = 'photo'
...
urlpatterns = [
    ...
    path('<int:photo_id>/like/', like_photo, name='like'),
